...
const getHouseColors = (houseId: string) => {
  const houseColorMap: Record<string, string> = {
    gryffindor: 'from-red-600 to-red-700',
    slytherin: 'from-blue-600 to-blue-700',
    ravenclaw: 'from-green-600 to-green-700',
    hufflepuff: 'from-yellow-600 to-yellow-700',
  };
  return houseColorMap[houseId] || 'from-gray-600 to-gray-700';
};
              ...
              <div className='flex items-center gap-4'>
                <Select onValueChange={setSelectedHouse} value={selectedHouse}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value='gryffindor'>Treinador de Fogo 🔥</SelectItem>
                    <SelectItem value='slytherin'>Treinador de Água 💧</SelectItem>
                    <SelectItem value='ravenclaw'>Treinador de Planta 🌱</SelectItem>
                    <SelectItem value='hufflepuff'>Treinador de Elétrico ⚡</SelectItem>
                  </SelectContent>
                </Select>
              </div>
            </div>
                ...
                <DialogContent className='max-w-2xl'>
                  ...
                  <div className='space-y-4'>
                    ...
                    <div className='grid grid-cols-3 gap-4'>
                      ...
                      <div>
                        <Label htmlFor='galleon-reward'>Pokédólares</Label>
                        <Input
                          id='galleon-reward'
                          onChange={(e) =>
                            setNewMission({
                  ...
                  <div>
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value='galleons'>Pokédólares</SelectItem>
