    ...
    <div className='container mx-auto p-0 md:p-6'>
      ...
      <Dialog open={!!classRequiringPassword} onOpenChange={(isOpen) => !isOpen && handleCloseDialog()}>
        <DialogContent className='magical-border bg-card border-accent/20'>
          <DialogHeader><DialogTitle>Acesso à Turma Privada: {classRequiringPassword?.name}</DialogTitle><DialogDescription>Esta turma é protegida. Digite a senha para entrar.</DialogDescription></DialogHeader>
